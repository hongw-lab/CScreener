...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNewWindow.setText(QCoreApplication.translate("MainWindow", u"NewWindow", None))
        ...
        self.control_panel.setTabText(
            ...
            QCoreApplication.translate("MainWindow", "Image", None),
        )
        self.control_panel.setTabText(
            self.control_panel.indexOf(self.tab_2),
